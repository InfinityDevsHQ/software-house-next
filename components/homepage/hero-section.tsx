...
export default function HeroSection() {
  return (
    <>
      <section className="hero-bg flex items-center px-2.5 py-12 relative !lg:h-[600px]">
        <div className="md:pl-12 lg:pl-24 py-2 md:py-20 lg:py-24 mt-20 md:mt-0 xl:pl-10">
          <div className="max-w-lg flex flex-col gap-5 text-left">
